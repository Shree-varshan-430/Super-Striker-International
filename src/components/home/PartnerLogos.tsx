...
export default function PartnerLogos() {
  return (
    <section className="py-16 bg-[#11123c] text-white border-t border-white/5 select-none">
      <div className="max-w-[95%] mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 mt-10">
          {PARTNERS.map((partner, index) => (
            <div
              key={index}
              className="flex items-center gap-4 bg-white/3 border border-white/5 px-8 py-5 rounded-2xl shadow-sm hover:border-[#e9d319] hover:shadow-[0_0_20px_rgba(220,225,53,0.05)] transition-all duration-300 group"
            >
              <div className="w-10 h-10 rounded-full bg-white/5 text-white flex items-center justify-center shadow-md transition-transform duration-300 group-hover:scale-105">
                <Shield className="h-5 w-5 fill-[#e9d319] text-[#e9d319]" />
              </div>
