      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {selectedCategory === "All" && featuredArticle && (
          <motion.div
            ...
            className="group grid grid-cols-1 lg:grid-cols-12 border border-gray-100 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all mb-16 bg-white"
          >
            ...
            <div className="lg:col-span-5 p-8 lg:p-12 flex flex-col justify-between gap-8 bg-white">
              <div className="flex flex-col gap-4">
                ...
                <h2 className="font-display text-2xl lg:text-3xl font-bold uppercase tracking-tight text-secondary-navy group-hover:text-primary-sky transition-colors leading-tight">
              ...
              <div className="flex items-center justify-between border-t border-gray-100 pt-6">
                ...
                <Link
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-secondary-navy text-white hover:bg-primary-sky hover:text-secondary-navy transition-all active:scale-95"
              ...
              <button
                ...
                className={`px-5 py-2.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all ${
                  selectedCategory === cat
                    ...
                    : "bg-background-soft text-secondary-navy hover:bg-gray-200"
                }`}
              >
                {cat}
              </button>
        ...
        {gridArticles.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {gridArticles.map((article) => (
              <motion.article
                ...
                className="group flex flex-col bg-white border border-gray-100 rounded-xl overflow-hidden hover:shadow-lg transition-shadow flex-grow"
              >
                ...
                <div className="p-6 flex flex-col flex-1 justify-between gap-6">
                  <div className="flex flex-col gap-3">
                    <h3 className="font-display text-lg font-bold uppercase tracking-tight leading-snug text-secondary-navy group-hover:text-primary-sky transition-colors">
          ...
          <div className="text-center py-20 bg-background-soft rounded-2xl border border-gray-100">
            ...
            <button
              ...
              className="mt-4 inline-flex text-xs font-bold uppercase tracking-wider text-primary-sky hover:underline"
            >
              Reset Filters
            </button>
          </div>
